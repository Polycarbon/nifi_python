...
#    apt-get -y install libbz2-dev libc6-dev libgdbm-dev libncursesw5-dev libssl-dev libsqlite3-dev tk-dev && \
#    wget -O /tmp/python3.6.9.tgz https://www.python.org/ftp/python/3.6.9/Python-3.6.9.tgz && \
#    cd /tmp && tar -zxvf python3.6.9.tgz && cd Python-3.6.9 && ./configure --prefix=/usr && make && make install && \
#    cd .. && rm -r Python-3.6.9

USER nifi

RUN pip3 install --user avro fastavro flatdict python-snappy
